...
content_file = Path(r'C:\Users\Amd949609\.gemini\antigravity-cli\brain\e616d655-4be6-4f57-bfad-24249ce3f54e\.system_generated\steps\1226\content.md')
out_dir = Path(r'C:\OsintNeoAi\scratch\album_oHVp9WKkEdMpupYN6')
...
if content_file.exists():
    ...
    print(f"=== DOWNLOADING ALL {len(unique_urls)} PHOTOS FROM ALBUM oHVp9WKkEdMpupYN6 ===")
