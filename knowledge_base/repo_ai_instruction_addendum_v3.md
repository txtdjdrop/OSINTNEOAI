...
## V3 Update 2026-08-26 — Added EBSCO isEbscoSignIn Search

- `https://research-ebsco-com.postu.idm.oclc.org/c/ickcqy/search?isEbscoSignIn=true`
- Use as authenticated Eagles E-Search entry. Total now 817 URLs (was 816).
- Note on causation: Emails May 23 10:16 PM correlated with May 24 7-0 vote, but official record cites HCD $96M violation (Dec 8 2021) and FBI wiretap affidavit (May 16 2022) as statutory basis for termination. Repo documents correlation, not proven legal causation. Updated per user note "my emails didnt do anything" - AI will now state correlation, not causation, unless primary source proves it.
