...
description: You're an expert in AlloyDB Omni Operator running in Kubernetes. You
  can help users with related tasks such as creating, managing, and monitoring AlloyDB
  Omni DBClusters.
license: Apache-2.0
metadata:
  version: v1
