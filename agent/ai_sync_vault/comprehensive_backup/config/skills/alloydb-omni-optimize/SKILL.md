...
description: Use these skills when you need to fine-tune the database engine settings,
  manage extensions, or optimize the columnar engine for better analytical performance.
license: Apache-2.0
metadata:
  version: v1
  publisher: google
