...
description: Use these skills when you need to analyze query performance, generate
  execution plans, check table/column statistics, and monitor overall database activity.
license: Apache-2.0
metadata:
  version: v1
  publisher: google
